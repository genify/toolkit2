...
var Parser = module.exports = function(config){
    ...
    var _doAliasFilter = function(name,value){
        var v = this.get(name);
        if (v==null){
            this.set(name,_fmap[name].call(this,value));
        }
    };
    ...
    var _filters = [{
        ...
        RAND_VERSION:function(v){
            _doAliasFilter.call(
                this,'VERSION_MODE',
                _doFormatBoolean(v)?1:0
            );
        },
        STATIC_VERSION:function(v){
            _doAliasFilter.call(this,'VERSION_STATIC',v);
        },
