...
pro._outputWebCacheConfig = function(){
    ...
    // output web cache config
    var name = tmp.root+'webcache.json';
    _log.logger.info('output web cache config to %s',name);
    _fs.write(name,JSON.stringify(config,null,4));
};
/**
