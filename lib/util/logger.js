...
pro.debug = function(){
    ...
    args.unshift('debug'.toUpperCase());
...
pro.error = function(){
    var args = [].slice.call(arguments,0);
    args.unshift('error'.toUpperCase());
    this._log.apply(this,args);
};
/**
 * log information
