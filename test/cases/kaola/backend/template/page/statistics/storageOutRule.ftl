...
<script type="text/javascript">
    window.__warehouseList__ = ${stringify(warehouseList![])};
    var warehouseMap = {};
    for(var i=0,l=__warehouseList__ .length;i<l;i++){
        warehouseMap[__warehouseList__[i].warehouseId] = __warehouseList__[i].warehouseName;
    }
</script>
<script src="${lib_root}define.js?pro=${pro_root}"></script>
<script src="/backend/src/js/module/statistics/storageOutRule.js"></script>
</body>
</html>