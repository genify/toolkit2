 ...
 * @return {Void}
 */
var _writeFile = function(file,content,charset,method){
    try{
        if (!file){
            return;
        }
...
exports.write = function(file,content,charset){
    _writeFile(file,content,charset,'writeFileSync');
};
/**
 ...
 * @return {Void}
 */
exports.writeAsync = function(file,content,charset){
    _writeFile(file,content,charset,'writeFile');
};
/**
