...
var __doParseJSContent = (function(){
    ...
    var _doParseNEJPatchCode = function(_map,_owner,_result,_alias){
        ...
        if (_arr.length>0){
            ...
            // generate code
            _code = util.format(
                'function(%s){var %s = arguments[%s]._$KERNEL;%s;%s}',
    ...
    return function(_alias,_list,_result){
        ...
        if (_alias==_r1||_alias==_r2){
            _map.code = 'var I$=function(){var a={},b=[],c=function(){return!1},d={};return function(e,f){var g=d[e],h="[object Function]"===a.toString.call(f);if(null==f||h||(g=f),g||(g={}),d[e]=g,h){for(var i=[],j=2,k=arguments.length;k>j;j++)i.push(I$(arguments[j]));var l={};i.push.call(i,l,a,c,b);var m=f.apply(null,i)||l;for(var n in m)g[n]=m[n]}return g}}();\n'+_map.code;
        }
        // update result
