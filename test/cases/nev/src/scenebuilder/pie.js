...
define(['{pro}/libs/colorbox.js', 
        ...
        function(
           ...
           */
          function build(rootSelection, dataPoints, value, hidden)
          {
            //console.log("jdhjfhfhhfhfhfhfh",dataPoints);
            ...
            if(!hidden){
              var annotation = annotations.selectAll(function(actor){
