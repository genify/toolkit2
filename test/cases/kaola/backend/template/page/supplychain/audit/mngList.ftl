                    ...
                    <div class="detail">
                        <div id="searchbox" class="w-dataform f-clearfix">
                        	<form id="searchForm">
                        		...
                        		<div class="f-group f-rowgroup">
                        			<div class="col col-span2">审批单状态：
                        			...
                        			<div class="col col-span3">&nbsp;</div>
                        			<div class="col col-span2">
                        				采购单号： <input type="text" placeholder="输入审批单号搜索" name="purchaseOrderId"/>
                        			</div>
...
<script src="/backend/src/js/module/supplychain/audit/mngList.js"></script>
</body>
</html>