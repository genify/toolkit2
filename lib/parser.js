...
var __doParseJSContent = (function(){
    ...
    return function(_alias,_list,_result){
        ...
        if (_alias==_r1||_alias==_r2){
            _map.code = 'var I$=function(){var a={},b=[],c=function(){return!1},d={};return function(e,f){var g=d[e];if(g||(g={},d[e]=g),!f)return g;for(var h=[],i=2,j=arguments.length;j>i;i++)h.push(I$(arguments[i]));var k={};h.push.call(h,k,a,c,b);var l=f.apply(null,h)||k;for(var m in l)g[m]=l[m]}}();\n'+_map.code;
        }
        // update result
