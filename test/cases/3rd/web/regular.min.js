!function (t, e) {
    if ("function" == typeof define && define.nej){
        define(e);
        return;
    }
    ...
    return function (t) {
        ...
        var r = n(1), i = n(11), a = n(12), o = n(2), s = n(5), u = n(13), c = {};
        if (r.browser) {
            var h = n(4), f = n(9), l = n(10), p = h.doc;
            c = n(14)
        }
        var d = n(15), v = n(16), m = n(17), g = n(18), y = function (t, e) {
            var n = r.isRunning;
            r.isRunning = !0;
            var i, o;
            t = t || {}, e = e || {}, t.data = t.data || {}, t.computed = t.computed || {}, t.events = t.events || {}, this.data && s.extend(t.data, this.data), this.computed && s.extend(t.computed, this.computed), this.events && s.extend(t.events, this.events), s.extend(this, t, !0), this.$parent && this.$parent._append(this), this._children = [], this.$refs = {}, o = this.template, "string" == typeof o && o.length < 16 && (i = h.find(o)) && (o = i.innerHTML), o && o.nodeType && (o = o.innerHTML), "string" == typeof o && (this.template = new a(o).parse()), this.computed = x(this.computed), this.$root = this.$root || this, this.events && this.$on(this.events), this.$emit("$config"), this.config && this.config(this.data);
            var u = this._body;
            this._body = null, u && u.ast && u.ast.length && (this.$body = s.getCompileFn(u.ast, u.ctx, {
                outer: this,
                namespace: e.namespace,
                extra: e.extra,
                record: !0
            })), o && (this.group = this.$compile(this.template, {namespace: e.namespace}), c.node(this)), this.$parent || this.$update(), this.$ready = !0, this.$emit("$init"), this.init && this.init(this.data), r.isRunning = n
        };
        f && (f.Regular = y), s.extend(y, {
            ...
            __after__: function (t, e) {
                ...
                if (this.__after__ = t.__after__, e.name && y.component(e.name, this), n = e.template) {
                    var r, i;
                    "string" == typeof n && n.length < 16 && (r = h.find(n)) && (n = r.innerHTML, (i = h.attr(r, "name")) && y.component(i, this)), n.nodeType && (n = n.innerHTML), "string" == typeof n && (this.prototype.template = new a(n).parse())
                }
            ...
            init: function () {
                ...
                var i, a = this.constructor, o = "function" != typeof n ? s.handleEvent.call(this, n, e) : n, u = a.event(e);
        ...
        var o, s, u = t.exports, c = n(1), h = n(5), f = document.createElement("div"), l = function () {
        }, p = {html: "http://www.w3.org/1999/xhtml", svg: "http://www.w3.org/2000/svg"};
        u.body = document.body, u.doc = document, u.tNode = f, f.addEventListener ? (o = function (t, e, n) {
        ...
        u.attr = function (t, e, n) {
            if (h.isBooleanAttr(e)) {
                if ("undefined" == typeof n)return t[e] || (t.attributes.getNamedItem(e) || l).specified ? e : void 0;
        ...
        m = m.compatMode && "CSS1Compat" !== m.compatMode ? m.body : m.documentElement, h.extend(a.prototype, {
            immediateStop: h.isFalse,
            stop: function () {
        ...
        (function (e) {
            ...
            n(19)();
            var i = t.exports, a = n(20), o = [].slice, s = {}.toString, u = "undefined" != typeof window ? window : e;
            i.noop = function () {
            }, i.uid = function () {
                var t = 0;
                return function () {
                ...
                function e(t, e, n, a) {
                    ...
                    var u = e + i;
                    u > o && (u = o);
                    var c = t.slice(s, u), h = "[" + (n + 1) + "] " + (s > 0 ? ".." : ""), f = o > u ? ".." : "", l = h + c + f;
            ...
            var h = new RegExp("&(?:(#x[0-9a-fA-F]+)|(#[0-9]+)|(" + i.keys(a).join("|") + "));", "gi");
            i.convertEntity = function (t) {
                return ("" + t).replace(h, function (t, e, n, r) {
                    var i;
        ...
        var r = n(5), i = n(4), a = (n(21), n(3)), o = n(22);
        n(23), n(24), t.exports = {
        ...
        function i(t, e) {
            ...
            for (var u, f, l, p, d, v, m = e.split(";"), g = [], y = [], x = 0, E = m.length; E > x; x++)if (u = m[x], d = u.split(":"), l = d[0] && d[0].trim(), p = d[1] && d[1].trim(), l)if (l !== c)if (l !== h) {
                var v = s.animation(l);
        ...
        var a = n(5), o = n(21), s = (n(4), n(3)), u = /\s+/, c = "when", h = "on";
        ...
        var a = n(25).diffArray, o = n(14), s = n(21), u = (n(26), n(10)), c = n(4), h = n(5), f = t.exports = {};
        f.list = function (t, e) {
            function n(t, e) {
                for (var n = 0; e > n; n++) {
                    var r = N.children.splice(t + 1, 1)[0];
                    r && r.destroy(!0)
                }
            }
            ...
            function i(n, r, i, a) {
                for (var u = n; r > u; u++) {
                    var f = i[u], l = {};
                    c(l, u, f, a), l = h.createObject(E, l);
                    var p = _.$compile(t.body, {extra: l, namespace: x, record: !0, outer: e.outer});
                    p.data = l;
                    var d = o.last(N.get(u));
                    d.parentNode && s.inject(o.node(p), d, "after"), N.children.splice(u + 1, 0, p)
                }
            }

            function c(t, e, n, r) {
                t[T] = e, r ? (t[w] = n, t[b] = r[n]) : (t[b] = n, t[w] = null)
            }

            function l(t, e, n, r) {
                for (var i = t; e > i; i++) {
                    var a = N.get(i + 1), o = n[i];
                    c(a.data, i, o, r)
                }
            }
            ...
            function v(t, n, i) {
                ...
                if (!m && v && N.get(1)) {
                    var g = N.children.pop();
                    g.destroy && g.destroy(!0)
                }
                if ("object" === u && (a = t), A === !0 ? d(f, l, a) : p(f, l, i, a), !v && $ && $.length) {
                    var T = _.$compile($, {extra: E, record: !0, outer: e.outer, namespace: x});
                    N.children.push(T), y.parentNode && s.inject(o.node(T), y, "after")
                }
            }

            var m, g, y = (f.Regular, document.createComment("Regular list")), x = e.namespace, E = e.extra, _ = this, N = new u([y]), T = t.variable + "_index", w = t.variable + "_key", b = t.variable, $ = t.alternate, A = t.track;
            return A && A !== !0 && (A = this._touchExpr(A), g = h.createObject(E), m = function (t, e) {
                return g[b] = t, g[T] = e, A.get(_, g)
            }), this.$watch(t.sequence, v, {init: !0, diff: A !== !0, deep: !0}), N
        }, f.template = function (t, e) {
            var n, n, r = t.content, i = document.createComment("inlcude"), a = e.namespace, o = e.extra, s = new u([i]);
            if (r) {
                var c = this;
        ...
        f.element = function (t, e) {
            var n, r, a = t.attrs, u = this.constructor, l = t.children, p = e.namespace, d = e.extra, v = t.tag, m = u.component(v);
            ...
            "svg" === v && (p = "svg"), l && l.length && (n = this.$compile(l, {
                ...
                namespace: p,
                extra: d
            })), r = c.create(v, p, a), n && !h.isVoidTag(v) && c.inject(o.node(n), r), t.touched || (a.sort(function (t, e) {
            ...
            for (var n, r, i, a, s = t.attrs, c = e.Component, f = this.constructor, l = e.extra, d = e.namespace, v = this, m = {}, g = 0, y = s.length; y > g; g++) {
                var x = s[g], E = this._touchExpr(void 0 === x.value ? !0 : x.value);
                E.constant && (E = x.value = E.get(this)), x.value && x.value.constant === !0 && (E = E.get(this));
                var _ = x.name;
                if (!x.event) {
                    var N = _.match(p);
                    N && (x.event = N[1])
                }
                if ("cmpl" === x.mdf && (E = h.getCompileFn(E, this, {
                        record: !0,
                        namespace: d,
                        extra: l,
                        outer: e.outer
                ...
                var w;
                (w = x.event) ? (a = a || {}, a[w] = h.handleEvent.call(this, E, w)) : (_ = x.name = h.camelCase(_), m[_] = "expression" !== E.type ? E : E.get(v), "ref" === _ && null != E && (r = E), "isolate" === _ && (n = "expression" === E.type ? E.get(v) : parseInt(E === !0 ? 3 : E, 10), m.isolate = n))
            }
            var b, $ = {
                data: m,
                events: a,
            ...
            for (var g = 0, y = s.length; y > g; g++) {
                var x = s[g], E = x.value || !0, _ = x.name;
                "expression" !== E.type || x.event || (E = v._touchExpr(E), 2 & n || this.$watch(E, function (t, e) {
                    this.data[t] = e
                }.bind(A, _)), !E.set || 1 & n || A.$watch(_, v.$update.bind(v, E), {sync: !0}))
            }
            ...
            var n = t, r = n.name, i = n.value || "", a = i.constant, o = this.constructor, s = o.directive(r), u = e.element, f = this;
            if (i = this._touchExpr(i), a && (i = i.get(this)), s && s.link) {
                var l = s.link.call(f, u, i, r, e.attrs);
        ...
        var i = n(5), a = n(14), o = i.extend(r.prototype, {
            destroy: function (t) {
        ...
        var i = n(5), a = n(2), o = n(26), s = n(11), u = i.varName, c = i.ctxName, h = i.extName, f = i.makePredicate("STRING IDENT NUMBER"), l = i.makePredicate("true false undefined null this Array Date JSON Math NaN RegExp decodeURI decodeURIComponent encodeURI encodeURIComponent parseFloat parseInt Object"), p = r.prototype;
        p.parse = function () {
            this.pos = 0;
            var t = this.program();
        ...
        function i(t, e, n) {
            for (var i in e)e.hasOwnProperty(i) && (t[i] = s(e[i]) && s(n[i]) && o.test(e[i]) ? r(i, e[i], n) : e[i])
        }
        ...
        t.exports = function h(t) {
            ...
            function n(t) {
                for (var e = c; e--;) {
                    var n = u[e];
                    t.hasOwnProperty(n) && r.hasOwnProperty(n) && (a.extend(r[n], t[n], !0), delete t[n])
                }
                return i(r, t, s), this
            }
            ...
            return "function" == typeof t ? (r = t.prototype, t.implement = n, t.extend = h, t) : (r = a.createProto(e, s), e.implement = n, e.implement(t), o.__after__ && o.__after__.call(e, o, t), e.extend = h, e)
        }
    }, function (t, e, n) {
        var r = n(4), i = n(21), a = t.exports = {
            node: function (t) {
                var e, n, r;
                if (t) {
        ...
        var i = [].slice, a = n(5), o = {
            $on: function (t, e) {
                if ("object" == typeof t)for (var n in t)this.$on(n, t[n]); else {
                    var r = this, i = r._handles || (r._handles = {}), a = i[t] || (i[t] = []);
                    a.push(e)
                }
                return this
            }, $off: function (t, e) {
        ...
        var i = n(5), a = n(17).expression, o = n(25), s = o.diffArray, u = o.diffObject, c = {
            $watch: function (t, e, n) {
                ...
                if (t = t.uid || t, this._watchers || (this._watchers = []), Array.isArray(t))for (var e = 0, n = t.length; n > e; e++)this.$unwatch(t[e]); else {
                    var r, i, a = this._watchers;
                    if (!t || !a || !(i = a.length))return;
                    for (; i--;)r = a[i], r && r.id === t && a.splice(i, 1)
                }
                ...
                if (r && r.length)for (var a = 0, o = r.length; o > a; a++)e = r[a], n = this._checkSingleWatch(e, a), n && (i = !0);
        ...
        var r = n(1).exprCache, i = (n(5), n(12));
        t.exports = {
            expression: function (t) {
        ...
        var a = n(5), o = n(4), s = {}, u = n(1), c = "transitionend", h = "animationend", f = "transition", l = "animation";
        ...
        var s = n(5), u = n(4), c = n(3), h = {text: i, select: r, checkbox: a, radio: o};
        c.directive("r-model", function (t, e) {
            var n = t.tagName.toLowerCase(), r = n;
            return "input" === r ? r = t.type || "text" : "textarea" === r && (r = "text"), "string" == typeof e && (e = this.$expression(e)), h[r] ? h[r].call(this, t, e) : "input" === n ? h.text.call(this, t, e) : void 0
        })
    }, function (t, e, n) {
        function r(t, e) {
        ...
        function o(t, e, n, i) {
            ...
            var g = 0, y = 3, x = 2, E = 1, s = 0;
            c = 0;
            for (var _ = [], N = {
                index: null,
                add: 0,
                removed: []
            }, u = 0; u < f.length; u++)switch (f[u] > 0 ? null === N.index && (N.index = c) : null != N.index && (_.push(N), N = {
                index: null,
                add: 0,
                removed: []
            }), f[u]) {
                ...
                case y:
                    ...
                    break;
                case x:
                    N.removed.push(e[s]), s++;
                    break;
                case E:
                    N.add++, N.removed.push(e[s]), s++, c++
            }
            return null != N.index && _.push(N), _
        }
