...
<@htmHead title="订单监控">
	...
	<link rel="stylesheet" type="text/css" href="${css_root}module/pricemodel/profits.css">
</@htmHead>
<@topHeader />
                ...
                <div class="m-databox">
                    ...
                    <div class="detail">
                        <div id="searchbox" class="w-dataform f-clearfix">
                            ...
                            <#assign payMethodList = [{"payid":"1","payname":"网易宝"},{"payid":"2","payname":"支付宝国际"},{"payid":"3","payname":"支付宝"}] /> -->
                            ...
                            <#assign paylist=[{"text":"全部","value":""}] />
                            <#list payMethodList as pm>
                                <#assign paylist=paylist+[{"text":pm.value,"value":pm.index}] />
                            </#list>
                            <#assign storageDateValues=[{"text":"库存","value":1},{"text":"库存天期(7天)","value":2},{"text":"库存天期(30天)","value":3}] />
                            <@searchForm filters=[
                                [{"label":"支付方式","type":"SELECT","name":"payMethod","values":paylist},
                            	{"label":"跨境方式","type":"SELECT","name":"importType","values":importType},
                            	{"label":"入库仓库","type":"SELECT","name":"storageId","values":wareHouse},
                            	<#-- {"label":"商品编号","type":"TEXT","name":"goodsId","mustNum":"1"}, -->
                            	<#-- {"type":"SELECT","name":"type","values":storageDateValues}, -->
                            	{"label":"选择日期","type":"LABEL"},
...
<script src="/backend/src/js/module/pricemodel/orderprofits.js"></script>
</body>
</html>