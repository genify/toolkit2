            ...
            <div class="m-main">
                <div class="m-databox">
                    <div class="head head-1 f-cb m-actionbar">
                        <ul class="m-tab f-cb">
                        	<li><a href="/backend/auditTask/pendinglist">待审批任务(${total!''})</a></li>
                        	<li class="crt"><a href="/backend/auditTask/completedlist">已审批任务</a></li>
                        </ul>
                    </div>
                    <div class="detail">
...
<script src="/backend/src/js/module/supplychain/audit/completedlist.js"></script>
</body>
</html>