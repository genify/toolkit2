...
/**
 * unwrap content template
 * @param  {String} content - file content
 * @param  {Object} dict    - variables dict
 * @return {String} content after unwrap
 */
exports.unwrap = function(content,dict){
    dict = dict||{};
    return (content||'').replace(/#<(.*?)>/g,function($1,$2){
        return dict[$2]||$1;
    });
};