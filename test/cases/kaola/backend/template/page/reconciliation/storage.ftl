...
<script>
	...
	_wareHouses.push({'id':${wareHouse.warehouseId!-1}, 'name':'${wareHouse.warehouseName!''}'})
	</#list>
	var _config = {total : ${total!0}, handledTotal: ${handledTotal!0}, notHandledTotal: ${notHandledTotal!0}, wareHouses:_wareHouses};
</script>

<@htmFoot />
<!-- @DEFINE -->
<script src="${lib_root}define.js?pro=${pro_root}"></script>
<script src="/backend/src/js/module/reconciliation/storage.js"></script>
</body>
</html>