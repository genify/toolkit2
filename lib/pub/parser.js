        ...
        if (_isIgnore(_tag.type)){
            ...
            if (!!_source){
                if (_tag.name=='VERSION'){
                    ...
                    var location = {};
                    try{eval(_source);}catch(e){}
                    if (!_result.config){
                        _result.config = {};
                    }
                    var _root = (location.config||{}).root||'./';
                    _result.config.root = _root;
                    _result.config.dir = _doComplete(_root,_file);
                }else{
...
var __doParseJSContent = (function(){
    ...
    return function(_alias,_list,_result){
        ...
        if (_alias==_r1||_alias==_r2){
            _map.code = 'var I$=function(){var a={},b=[],c=function(){return!1},d={},e=function(b,c){return a.toString.call(b)==="[object "+c+"]"};return function(f,g){var h=d[f],i=e(g,"Function");if(null==g||i||(h=g),h||(h={}),d[f]=h,i){for(var j=[],k=2,l=arguments.length;l>k;k++)j.push(I$(arguments[k]));var m={};j.push.call(j,m,a,c,b);var n=g.apply(null,j)||m;if(e(n,"Object"))for(var o in n)h[o]=n[o];else h=n,d[f]=h}return h}}();\n'+_map.code;
        }
        // update result
