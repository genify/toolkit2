...
<div class="g-bd">
	<div class="g-bdc">
		<div class="m-upside f-cb">
            ...
            <a href="/backend/invoicing/stockin/export" target="_blank" class="w-btn w-btn-black f-fr">导出入库审核报表</a>
            <#--<button id="js-exportin" class="w-btn w-btn-black f-fr">导出入库审核报表</button>-->
		</div>
...
<script src="/backend/src/js/module/psinventory/audit.js"></script>
</body>
</html>