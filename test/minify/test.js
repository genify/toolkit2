...
var result = obf.obfuscate({
    ...
    obf_line_mode:1,
    code_map:{
        '2.js':'var x ={}; x[\'__abc\'] = \'xxxx\';e = {7:\'rgb\',\'a-b\':4,__init : 0,__reset : 1,__destroy : 2,__initNode : 3,__doBuild : 4,__onShow : 5,__onHide : 6,__onRefresh : 7}, t = {__supInit : 0,__supReset : 1,__supDestroy : 2,__supInitNode : 3,__supDoBuild : 4,__supOnShow : 5,__supOnHide : 6,__supOnRefresh : 7};',
        ...
        'f.js':fs.readFileSync('./event.js', "utf8")
    }
});
