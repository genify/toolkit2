...
var _gCache = {
    params:{},
    nejInjector:'I$',
    nejProcessor:require('./processor.js')
};
...
exports.formatDependencies = (function(){
    ...
    var _doFormatPlugin = function(name,config,plugins){
        ...
        if (typeof content!=='string'&&
            _util.isFunction(content.stringify)){
            content = content.stringify();
        }
        // check plugin precessor
