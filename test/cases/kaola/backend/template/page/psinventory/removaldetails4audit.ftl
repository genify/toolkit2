	...
	<div class="g-bdc">
		...
		<div class="m-content w-table">
			...
			<div style="margin-top:20px; text-align:center;">
				<button id="checkbtn" class="w-btn w-btn-blue">出库确认</button>
			</div>
            <div style="margin-top:20px; text-align:center;">
                <button id="reject_btn" class="w-btn w-btn-red">出库拒绝</button>
            </div>
			</#if>
			<div class="remark">
...
<!-- @NOPARSE -->
<script>
	var _config = {sockId : ${stockOut.id!""}, type: 1};
</script>
<!-- /@NOPARSE -->
