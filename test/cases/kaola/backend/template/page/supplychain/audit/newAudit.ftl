            ...
            <div class="m-main">
                <div class="m-databox">
                    <div class="head head-1 f-clearfix m-actionbar">
                        <h2 class="icf-keyboard">新建审批单</h2>
                        	...
                        	<form id="searchForm">
                        		<div class="f-rowgroup">
                        			...
                        			<div class="col col-span2">
                        				...
                        				<input type="text" name="competitor" value="${(auditOrder.competitor)!''}" data-required="true">
                        			</div>
                        		</div>
                        		<div class="f-rowgroup">
                        			<div class="col col-span2">
                        				...
                        				<span class="w-datepick">
                        					<input type="text" name="expectArrivalDay" data-ignore="true" class="j-datepick" data-type="date" data-required="true" value=${(auditOrder.expectArrivalDay?number_to_datetime?string("yyyy-MM-dd"))!''}>
                        				</span>
                        			</div>
                        			<div class="col col-span2">
                        				<span class="m-important">*</span>预计入库日期
                        				<span class="w-datepick">
                        					<input type="text" name="expectInstockDay" data-ignore="true"  class="j-datepick" data-type="date"  data-required="true" value=${(auditOrder.expectInstockDay?number_to_datetime?string("yyyy-MM-dd"))!''}>
                        				</span>
                        			</div>
                        			<div class="col col-span2">
                        				运输方式
...
<script>
	var isEdit = <#if auditOrder??>true<#else>false</#if>
...
<script src="/backend/src/js/module/supplychain/audit/newAudit.js"></script>
</body>
</html>